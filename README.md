...
- Java uses && while python uses and 
- the for loop implementation is different 
- Java requires ; after most code lines 
- Java uses else if while python uses elif 
- Both languages used booleans 
...
the file. Then click the commit button to commit the change to the repository. Testing Pull
